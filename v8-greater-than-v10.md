...
Since v9 and v10 where released within a short interval here is a guide to upgrade directly from v8 to v10.
...
<pre class="language-diff" data-title="src/main.ts"><code class="lang-diff"> import { oidcEarlyInit } from "oidc-spa/entrypoint";
+import { browserRuntimeFreeze } from 'oidc-spa/browser-runtime-freeze';
