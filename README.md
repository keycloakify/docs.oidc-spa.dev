...
[^1]: In setup demo, you'll have a middleware that resolve the user identity of the user against a Redis database before starting SSR.\
    This significantly increase the delay before the user receive the page.\
    In practice large entreprise dashboard like Vercel will send a skeleton, resolve the identity, then stream the authed components. &#x20;

[^2]: They are actively working on it and making good progress. &#x20;

[^3]: Some claim they do but it does not always work in practice. &#x20;
