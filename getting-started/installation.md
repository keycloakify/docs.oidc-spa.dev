...
If you have not yet set up such a server, please refer to [our guide for instructions on how to provision and configure a Keycloak server](../api-reference/usage-with-keycloak.md).
{% endhint %}
